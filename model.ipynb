   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "mean          5.539333           5.007667   143.776923\n",
      "std           2.848829           3.160000   178.210708\n",
      "min           1.000000           0.000000     0.000000\n",
      "25%           3.000000           2.000000    40.000000\n",
      "50%           6.000000           5.000000    90.000000\n",
      "75%           8.000000           8.000000   166.670000\n",
   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "1                 9                  8      Very Good   \n",
      "3                10                  6  Above Average   \n",
      "10                9                  8      Very Good   \n",
      "11                4                  4      Excellent   \n",
      "13                1                  1      Excellent   \n",
      "\n",
      "                                     Job Profile Name  correctness  \n",
      "1   Cloud Platforms: Proficiency in cloud platform...        88.89  \n",
      "3                                Full Stack Developer        60.00  \n",
      "10                               Full Stack Developer        88.89  \n",
      "11                     Cloud Architectural Principles       100.00  \n",
      "13              Artificial Intelligence (AI) Engineer       100.00  \n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\dalvi\\AppData\\Local\\Temp\\ipykernel_20324\\1600865985.py:7: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
      "  data['Job Profile Name'] = label_encoder.fit_transform(data['Job Profile Name'])\n"
     ]
    }
   ],
   "source": [
    ...
    "\n",
    "# Fit and transform the 'Job Profile Name' column using label encoding\n",
    "data['Job Profile Name'] = label_encoder.fit_transform(data['Job Profile Name'])"
   ]
  },
  {
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "    total questions  correct questions    Performance  Job Profile Name  \\\n",
      "1                 9                  8      Very Good                18   \n",
      "3                10                  6  Above Average                40   \n",
      "10                9                  8      Very Good                40   \n",
      "11                4                  4      Excellent                17   \n",
      "13                1                  1      Excellent                10   \n",
      "\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\dalvi\\AppData\\Local\\Temp\\ipykernel_20324\\854457378.py:25: SettingWithCopyWarning: \n",
      "A value is trying to be set on a copy of a slice from a DataFrame.\n",
      "Try using .loc[row_indexer,col_indexer] = value instead\n",
      "\n",
      "See the caveats in the documentation: https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html#returning-a-view-versus-a-copy\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Predicted Performance for new data:Excellent\n"
     ]
    }
   ],
   "source": [
    ...
    "predicted_performance = train_model.predict(new_data)\n",
  ...
  },
  {
   ...
   "outputs": [
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "C:\\Users\\dalvi\\AppData\\Roaming\\Python\\Python310\\site-packages\\sklearn\\base.py:493: UserWarning: X does not have valid feature names, but RandomForestClassifier was fitted with feature names\n",
      "  warnings.warn(\n"
     ]
    }
   ],
   "source": [
    ...
    "print(model.predict([[40,10,30,6]]))"
   ]
  }
 ],
 "metadata": {
